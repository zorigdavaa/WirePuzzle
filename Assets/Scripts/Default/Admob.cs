...
//     }
//     void OnAnyAdClosed(object sender, EventArgs args)
//     {
//         switch (sender)
//         {
//             case BannerView _: RequestBannerAd(); break;
//             case InterstitialAd _: RequestAndLoadInterstitialAd(); break;
//             case RewardedAd _: RequestAndLoadRewardedAd(); break;
//             case RewardedInterstitialAd _: RequestAndLoadRewardedInterstitialAd(); break;
//         }
//     }
...
//         bannerView.OnAdClosed += (sender, args) => { OnAdClosedEvent.Invoke(); OnAnyAdClosed(sender, args); };
//         // Load a banner ad
...
//         interstitialAd.OnAdClosed += (sender, args) => { OnAdClosedEvent.Invoke(); OnAnyAdClosed(sender, args); };
...
//         rewardedAd.OnUserEarnedReward += (sender, args) => { OnAdClosedEvent.Invoke(); OnAnyAdClosed(sender, args); };
...
//                 });
//                 RequestAndLoadRewardedInterstitialAd();//i wrote this
//             });
//         }
//         else
//         {
